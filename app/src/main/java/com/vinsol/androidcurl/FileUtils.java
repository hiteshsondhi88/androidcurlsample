...
public class FileUtils {
	...
	public static final String curlFileName = "curl";
	...
	public static boolean copyBinaryFromAssetsToData(Context context, String fileNameFromAssets, String outputFileName) {
		...
		try {
			...
			// copy curl file from assets to files dir
    ...
    public static String getCurl(Context context) {
        return getFilesDirectory(context).getAbsolutePath() + File.separator + FileUtils.curlFileName;
    }
}